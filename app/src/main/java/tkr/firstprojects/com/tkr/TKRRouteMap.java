...
public class TKRRouteMap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tkr_route_map);
        initInstances();

        WebView myWebView = (WebView) findViewById(R.id.webView1);
        myWebView.getSettings().setJavaScriptEnabled(true);
        myWebView.loadUrl("https://docs.google.com/uc?export=&id=0B_pe9BXZFAtWcUVXdVliQnFad3c");
